...
std::string SimpleRenderer::shaderDir = Engine::projectDir + "/Renderer/shaders/";
//"/Renderer/shaders/
...
void SimpleRenderer::Render(std::unordered_set<Engine::Transform*>& transforms, int mesh)
{
	// Shader setup
	shader.enable();
...
glm::mat4 SimpleRenderer::ConstructModelMatrix(const Engine::Transform& transform)
{
