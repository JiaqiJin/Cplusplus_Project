...
//Load the rendering pipeline dependencie
void D3D12HelloWindow::LoadPipeline()
{
    ...
    swapChainDesc.BufferCount = FrameCount; //number of buffer to use in swap chain
    swapChainDesc.Width = m_width;
    swapChainDesc.Height = m_height;
    swapChainDesc.Format = DXGI_FORMAT_R8G8B8A8_UNORM;
    swapChainDesc.BufferUsage = DXGI_USAGE_RENDER_TARGET_OUTPUT; // rendering back buffer
...
void D3D12HelloWindow::LoadAssets()
{
    ...
    //Command list are created in recording state, but there is nothing
