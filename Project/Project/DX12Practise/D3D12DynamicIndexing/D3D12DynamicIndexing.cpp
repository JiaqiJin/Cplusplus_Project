...
void D3D12Bundles::LoadAssets()
{
    ...
    {
        ComPtr<ID3DBlob>vertexShaders, pixelShaders, pixelShaders1;
        vertexShaders = LoadBinary(L"HLSL\\shader_mesh_simple_vert.cso");
        pixelShaders = LoadBinary(L"HLSL\\shader_mesh_simple_pixel.cso");
        pixelShaders1 = LoadBinary(L"HLSL\\shader_mesh_alt_pixel.cso");
        ...
        psoDesc.VS = CD3DX12_SHADER_BYTECODE(vertexShaders.Get());
        psoDesc.PS = CD3DX12_SHADER_BYTECODE(pixelShaders.Get());
